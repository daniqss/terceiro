...
public interface CourseService {
     ...
     */
    public Course addCourse(String city, LocalDateTime startDate, BigDecimal price, int maxVacantSpots);
    ...
    */
    public List<Course> findCourses(String city, LocalDateTime date);
